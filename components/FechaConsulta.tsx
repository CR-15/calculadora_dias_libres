    ...
    <div className="flex flex-col gap-2.5">
      <div className="flex items-center gap-[14px] flex-wrap">
        ...
        <div className="flex-1 min-w-[200px] flex items-stretch gap-2">
          ...
          />
          {/*
            El input[type=date] transparente cubre todo el botón.
            Así el toque va directo al picker nativo del sistema operativo,
            sin pasar por showPicker() / .click() — funciona en iOS Safari,
            Android Chrome y cualquier desktop.
          */}
          <div
            className="relative flex-shrink-0 w-[46px] border-[1.5px] border-line-strong rounded-[9px] bg-card text-accent flex items-center justify-center overflow-hidden transition-colors duration-150 hover:border-accent hover:bg-work-bg active:translate-y-px"
          >
            <svg
              width="20"
              height="20"
